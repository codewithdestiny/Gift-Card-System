...
if($_SERVER['REQUEST_METHOD'] == "POST"){
     $updateInstance->changeUserPassword();
}
?>
<div class="dashboard-panel h-72 w-full col-span-10 ">
     <form class="md:px-16 md:pt-10 p-5 bg-sky-500 "  method="post" action="<?=htmlspecialchars($_SERVER['PHP_SELF']);?>">
          <fieldset class="md:mt-10 w-4/5 mx-auto">
               ...
               <button type="submit" class="bg-sky-600 md:mt-6 text-white hover:text-sky-300 py-2 px-5 rounded-full w-full">Change password</button>
