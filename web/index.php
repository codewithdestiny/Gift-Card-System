...
<body>
	...
	<div >
		<div class="md:grid grid-cols-12 w-full md:gap-0">
			<div class="col-span-2 relative md:h-screen md:p-0 px-5 py-5 bg-sky-700">
				<ul class="md:mt-7 md:ml-8">
					...
					<li class="flex justify-start hover:text-sky-300 transition-all text-sky-200 my-4 gap-2">
						<span>
							<svg xmlns="http://www.w3.org/2000/svg" width="23" Fheight="23" fill="currentColor" class="bi bi-list-nested" viewBox="0 0 16 16">
					...
					<li class="flex justify-start hover:text-sky-300 transition-all text-sky-200 my-6 gap-2">
						...
						<a href="./redeem-gift-card.php">Redeem Gift Cards</a>
					</li>
					<li class="flex justify-start hover:text-sky-300 transition-all text-sky-200 my-6 gap-2">
						<span>
			...
			<div class="col-span-10 bg-sky-100">
				<?php
				
				$url = @$_GET['tab']; // hide the error by default

				switch($url){
					case 'general-announcement.php':
						return require("./general-announcement.php");
						break;

					case 'user-wallet.php':
						return require("./user-wallet.php");
						break;

					case 'crypto-deposit.php':
						return require("./crypto-deposit.php");
						break;

					case 'redeem-gift-card.php':
						return require("./redeem-gift-card.php");
						break;

					case 'crypto-exchange.php':
						return require("./crypto-exchange.php");
						break;

					case 'user-payment.php':
						return require("./user-payment.php");
						break;

					case 'user-notification.php':
						return require("./user-notification.php");
						break;

					case "user-settings.php":
						return require("./user-settings.php");
						break;

					case 'needs-help.php':
						return require("./needs-help.php");
						break;

					case 'user-profile.php':
						return require("./user-profile.php");
						break;

					case 'referal.php':
						return require("referal.php");
						break;

					default:
						return require("user-dashboard.php");
						break;
				}
				?>
			</div>
